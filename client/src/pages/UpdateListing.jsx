...
useEffect(()=>{
 ...
 const handleSubmit=async(e)=>{
    ...
    try {
      ...
      const res=await fetch(`http://localhost:3000/api/listing/listing-update/${id}`,{
        method:"POST",
      ...
      if(data.success===true){
        ...
        setLoading(false)
        setError("Update listing failed.")
    }
   }
    ...
    return (
        ...
        <h1 className="font-semibold text-3xl text-center my-4 uppercase">Update a Listing</h1>
        ...
        <button disabled={loading || upLoading} type="submit" className="p-3 bg-gray-700 text-white rounded-lg w-full uppercase hover:opacity-90 disabled:opacity-75">{loading ? "Updating...":"Update Listing"}</button>
